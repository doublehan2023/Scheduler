    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-0.5">
          Here's what happening with your social accounts today.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {statCard.map((card) => (
          <div
            key={card.label}
            className="bg-white hover:bg-red-50 relative
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div
                className="text-xs absolute right-4 top-4 text-red-500 flex
              items-center gap-1"
              >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        ...
        {activities.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-6">
            <div
              className="size-12 bg-slate-100 rounde-xl flex items-center
              justify-center mb-3"
            >
